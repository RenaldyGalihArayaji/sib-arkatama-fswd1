    ...
    <div class="row justify-content-center">
      <div class="col-md-7">
          <h1 class=" mb-0 text-gray-800 font-title mb-3 text-center">Profil</h1>
            <div class="card shadow mb-4 pt-4 px-3">
              ...
              @endif
                <div class="card-body py-3">
                    <div class="d-flex justify-content-center">
                      @if (Auth::user()->image )
                        <img src="{{ asset('/storage/foto-profil_user/'. Auth::user()->image )}}" class="img-thumbnail rounded-circle " alt="{{ Auth::user()->name}}" style="width: 130px;height:130px">
                      @else 
                    ...
                    <div class="px-4">
                          ...
                          <div class=" my-2 me-auto">
                            <a href="/profilUser-edit" class="btn btn-primary">Update</a>
                        </div>
                    </div>
                </div>
            </div>
