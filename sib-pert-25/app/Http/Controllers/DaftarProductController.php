...
class DaftarProductController extends Controller
{
    public function allProduct()
    {
        ...
        return view('product.all-product', ["title" => "all-Product" , "data" => $data]);
    }
    ...
    public function create()  
    {
        ...
        return view('product.product-create', ["title" => "Product-Create" , "data" => $data]);
    }
    ...
    public function edit($id) 
    {
        ...
        return view('product.product-edit',["title" => "Product-edit","data" => $data , "dataCategory" => $dataCategory]);
    }
